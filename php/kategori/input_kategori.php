	...
	<div id="page">
		...
		<main>
			...
			<div class="order">
				<div class="container">
					<!-- Form -->
					<form action="proses_input_kategori.php" id="orderForm" name="orderForm" method="POST">
						<div class="row">
								...
								<div id="personalDetails" class="row contact-box">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input id="id_kategori" class="form-control" name="id_kategori" type="text" required maxlength="11"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="form-group">
                                            <label for="nama">Nama Kategori</label>
                                            <input id="nama" class="form-control" name="nama" type="text" required maxlength="255"/>
                                        </div>
                                    </div>
								</div>
										...
										<div class="row">
											<div class="col-lg-12">
                                                <button class="btn-form-func" type="submit">
													<span class="btn-form-func-content">SIMPAN KATEGORI BARU</span>
