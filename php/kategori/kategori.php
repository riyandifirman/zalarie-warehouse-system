					...
					<div class="col-lg-9 col-6">
						...
						<nav id="menu" class="main-menu">
							<ul>
								...
								<li><span><a href="#">Kategori</a></span></li>
							...
							<!-- Personal Details -->
								<div id="personalDetails" class="row contact-box">
									...
									<?php
										...
										echo "<td><a href='update_kategori.php?id_kategori=$data[id_kategori]' class='btn btn-primary' role='button' style='color:white;'><i class='fa fa-pencil' aria-hidden='true'></i></a>
										<a href='delete_kategori.php?id_kategori=$data[id_kategori]' class='btn btn-danger' role='button' style='color:white;'><i class='fa fa-trash' aria-hidden='true'></i></a></td>";
										echo "</tr>";
										echo "</tbody>";
									} ?>
									</table>
								...
								<div class="col-lg-4" style="margin: 0 auto ;" >
									<!-- Order Container -->
										<div class="row">
											<div class="col-lg-12">
												<a class="btn-form-func" role="button" href="input_kategori.php" style="color:white;">
													<span class="btn-form-func-content">INPUT KATEGORI BARU</span>
