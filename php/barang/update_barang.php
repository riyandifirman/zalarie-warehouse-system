			...
			<div class="order">
				<div class="container">
                    <?php
                        ...
                        $query_update = mysqli_query($koneksi, "SELECT * FROM barang WHERE kode_barang='$kode_barang'");
                        $query = "SELECT * FROM kategori";
                        $result = mysqli_query($koneksi, $query);
                        while ($row = mysqli_fetch_array($query_update)) {
                    ?>
					<!-- Form -->
					<form action="proses_update_barang.php" id="orderForm" name="orderForm" method="POST">
						<div class="row">
								...
								<div id="personalDetails" class="row contact-box">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input id="kode_barang" class="form-control" name="kode_barang" type="text" value="<?php echo $row['kode_barang']?>" readonly/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="nama">Nama Barang</label>
                                            <input id="nama" class="form-control" name="nama" type="text" value="<?php echo $row['nama']?>" required maxlength="50"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="stok">Stok</label>
                                            <input id="stok" class="form-control" name="stok" type="text" value="<?php echo $row['stok']?>" required maxlength="50"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="harga">Harga</label>
                                            <input id="harga" class="form-control" name="harga" type="text" value="<?php echo $row['harga']?>" required maxlength="50"/>
                                        </div>
                                    </div>
									<div class="col-lg-12">
										...
										<div class="row">
											<div class="col-lg-12">
                                                <button class="btn-form-func" type="submit">
													<span class="btn-form-func-content">SIMPAN PERUBAHAN BARANG</span>
