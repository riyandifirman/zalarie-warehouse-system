							...
							<!-- Personal Details -->
								<div id="personalDetails" class="row contact-box">
									...
									<?php
										...
										$query = mysqli_query($koneksi, "SELECT detail_order.*, barang.nama FROM detail_order JOIN barang ON detail_order.id_barang = barang.kode_barang WHERE id_order = '$id_order'");
										while($data = mysqli_fetch_array($query)){

										echo "<tbody>";
										echo "<tr>";
										echo "<td>".$data['id_detailorder']."</td>";
